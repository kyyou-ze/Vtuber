...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // --- GLSurfaceView dipasang PERSIS seperti contoh resmi Live2D:
        //     langsung jadi content view utama, bukan disisipkan ke container custom. ---
        ...
        // --- UI kita (tombol mic, gear, subtitle) ditumpuk DI ATAS GLSurfaceView
        //     lewat addContentView, terpisah total dari root content view di atas. ---
        val overlay = layoutInflater.inflate(R.layout.activity_main, null)
        addContentView(
            overlay,
            ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT)
        )

        txtSubtitle = overlay.findViewById(R.id.txtSubtitle)
        setupTts()
        setupSpeechRecognizer()

        overlay.findViewById<View>(R.id.btnSettings).setOnClickListener { showApiKeyDialog() }
        overlay.findViewById<View>(R.id.btnMic).setOnClickListener {
