...
public:
    ...
    */
    ...
    /**
     * @brief   Menerima path file wav (hasil TTS) dan memulai lipsync real-time.
     *          (dipanggil dari Kotlin lewat JNI setiap kali audio TTS baru diputar)
     *
     * @param[in]   filePath    path absolut file wav (bukan dari assets)
     */
...
private:
    ...
    */
    ...
    LAppWavFileHandler_Common _wavFileHandler; ///< lipsync real-time berdasarkan file wav TTS
